  ...
  <div class="grid grid-cols-11 mb-5 cms-condition">
    <div class="col-span-5 px-5">
      <div class="header border border-gray-400 px-2 py-1">
        <el-input v-model="data[0].title" class="el-input--custom"  placeholder="タイトル" />
      </div>
      <div class="header border-l border-r border-b border-gray-400 px-2 py-1 h-24">
        <el-input v-model="data[0].comments" class="el-textarea--custom" placeholder="コメント" resize="none" :rows="4" type="textarea" />
      </div>
    </div>
    <div class="col-span-5 px-5">
      <div class="header border border-gray-400 px-2 py-1">
        <el-input v-model="data[1].title" class="el-input--custom" placeholder="タイトル" />
      </div>
      <div class="header border-l border-r border-b border-gray-400 px-2 py-1 h-24">
        <el-input v-model="data[1].comments" class="el-textarea--custom" placeholder="コメント" resize="none" :rows="4" type="textarea" />
      </div>
    </div>
